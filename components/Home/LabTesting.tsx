  ...
  const consultationCardData = [
    {
      ...
      description:
        "Keep family members informed and involved in the care process.",
    },
    {
      title: "Medical Management",
      description:
        "Reminders and tracking for medications to ensure proper adherence. ",
    },
  ...
  return (
    <section className="bg-white flex justify-center items-center p-[84.5px] flex-col gap-[60px]">
      <div className="text-primary text-center px-6">
        ...
        <button className="btn bg-transparent border-secondary text-primary rounded-full mt-[30px]">
          Coming Soon
        </button>
      </div>
